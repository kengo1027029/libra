...
export function VendorReviewDetailPage({ vendorId }: Props) {
  ...
  const pageBackdrop =
    "-mx-4 -my-8 min-h-[calc(100dvh-8rem)] bg-[#eef0f3] px-4 py-10 md:-mx-10 md:-my-10 md:min-h-[calc(100dvh-6rem)] md:px-10 md:py-12";
        ...
        <div className="mx-auto max-w-[920px] space-y-6">
          ...
          <div className="space-y-5 pb-4">
            {filteredSortedReviews.length === 0 ? (
              <p className="rounded-[24px] border border-dashed border-neutral-300 bg-white px-6 py-14 text-center text-sm text-neutral-500">
                条件に一致する評価がありません。
              </p>
            ) : (
...
function ReviewCommentCard({ review }: { review: StoredVendorReview }) {
  ...
  return (
    <article className="rounded-[24px] border border-neutral-100 bg-white p-7 shadow-[0_2px_12px_rgba(15,23,42,0.04)] md:p-8">
